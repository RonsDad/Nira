    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <button
              ...
              className="ice-glass p-6 rounded-xl text-center interactive-scale transition-all duration-200 hover:scale-105"
      ...
      {captureMethod === 'camera' && !extractedData && (
        <div className="space-y-4">
          ...
          <div 
            className="relative rounded-xl overflow-hidden ice-glass-elevated"
            style={{ background: 'var(--ice-base)' }}
          >
            <video
              ref={videoRef}
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div 
                className="border-2 border-dashed rounded-xl w-80 h-48 flex items-center justify-center"
      ...
      {isProcessing && (
        <div 
          className="text-center py-8 ice-glass rounded-xl"
          style={{ background: 'var(--ice-base)' }}
        >
          <Scan 
            size={48} 
      ...
      {extractedData && (
        <div className="space-y-4">
          ...
          {previewImage && (
            <div 
              className="ice-glass p-4 rounded-xl"
              style={{ background: 'var(--ice-base)' }}
            >
              <img 
                src={previewImage} 
          ...
          {/* Extracted Data */}
          <div 
            className="ice-glass p-6 rounded-xl space-y-4"
            style={{ background: 'var(--ice-base)' }}
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
